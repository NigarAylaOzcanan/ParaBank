...
public class _CheckingAndSavingsSteps extends Parent {
    ...
    public void theUserSelectsTheAccountTypeFromTheDropDownMenu() {
        cnt.selectByText(cnt.selectAccountType, "CHECKING");
    }
    ...
    @And("The user selects the account of the {int} from Drop-Down menu")
    public void theUserSelectsTheAccountOfTheDropDownMenu(int index) {
